// Vendored from https://github.com/blaxxun-boop/ServerSync (MIT-style license, see LICENSE.txt
// in that repo). Distributed as a single source file by design -- not a NuGet package -- so we
// keep the upstream implementation here and consume it from Plugin.cs to synchronize the
// sail repository, permissions and behavior from the server to every connecting client.
#nullable enable
using System;
